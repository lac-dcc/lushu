...
class MergerTest {
    ...
    fun mergeOnce() {
        ...
        val testCases = listOf<TestCase>(
            ...
            TestCase("timestamp", "00:00:00", "12:34:56",
                     "[012]{2,2}[:]{1,1}[034]{2,2}[:]{1,1}[056]{2,2}"),
            TestCase("ip", "0.0.0.0", "12.34.56.78",
                     "[012]{1,2}[.]{1,1}[034]{1,2}[.]{1,1}[056]{1,2}[.]{1,1}[078]{1,2}"),
            TestCase("sub ip", "1.2.3", "123.456.789",
                     "[123]{1,3}[.]{1,1}[2456]{1,3}[.]{1,1}[3789]{1,3}"),
            TestCase("sub ip 2", "123.456.789", "12.34.78",
                     "[123]{2,3}[.]{1,1}[3456]{2,3}[.]{1,1}[789]{2,3}"),
            TestCase("alpha punct", "123a", "123:", ".*"),
            TestCase("timestamp and number", "00:00:00", "123", ".*"),
            TestCase("timestamp and partial timestamp", "00:00:00", "00:00", ".*"),
            TestCase("missing punct", "ab", "ab.", ".*"),
            TestCase("alpha and asterisk", "Specified", "*", ".*"),
            TestCase("square brackets", "[", "]", "[\\[\\]]{1,1}"),
            TestCase("num and multiple alpha", "7", "system", Fixtures.alnumStar),
            TestCase("crazy spam", "12312-3-1=231-=", "111--12=-312-23-=",
